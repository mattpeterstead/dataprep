...
- **Image Simple**: a direct image/caption card workflow with cropping, masking, captioning, text tools, statistics, and batch actions.
- **Image Advanced**: a desktop-style image workflow with category folders, movable category windows, category-specific controls, masking, text tools, statistics, and batch actions.
...
First launch defaults to **Image Simple**.

## Repository Layout

```text
imageprep_simple.py   Image Simple mode
imageprep.py          Image Advanced mode
...
- Image Simple / Image Advanced: `http://127.0.0.1:5000/`
...
If no saved image mode exists, the image launcher opens Image Simple. The video launcher always opens Video mode directly.
...
Image Simple keeps the workflow focused on cards in one view. It avoids the advanced desktop/category-window workflow.

### Image Advanced

Image Advanced opens into a desktop-style category view. Category folders can be created, edited, moved, opened into separate windows, minimized, and managed through context menus.
